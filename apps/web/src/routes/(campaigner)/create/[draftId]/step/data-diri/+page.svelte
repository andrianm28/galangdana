...
const STEP = "data-diri";
const ANSWER_KEY = "campaignerRole";
...
<div>
  <h2 class="mb-4 font-sans text-lg font-semibold text-neutral-900">Peran Anda</h2>
  ...
  <label for={ANSWER_KEY} class="mb-2 block font-sans text-sm font-medium text-neutral-900">
    Apa peran Anda dalam penggalangan dana ini?
  </label>
  <input id={ANSWER_KEY} bind:value type="text" placeholder="Contoh: Warga setempat, Panitia" class="w-full rounded-sm border border-neutral-200 px-3 py-2 font-sans text-base" />
