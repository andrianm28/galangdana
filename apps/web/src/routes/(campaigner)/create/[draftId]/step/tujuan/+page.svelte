...
<div>
  <h2 class="mb-4 font-sans text-lg font-semibold text-neutral-900">Apa tujuan penggalangan dana ini?</h2>
  ...
  <label for={ANSWER_KEY} class="mb-2 block font-sans text-sm font-medium text-neutral-900">
    Jelaskan tujuan secara singkat
  </label>
  <textarea id={ANSWER_KEY} bind:value class="w-full rounded-sm border border-neutral-200 px-3 py-2 font-sans text-base" rows="3"></textarea>
